...
{
	enum class [[ Reflected, Default(UNKNOWN_AXIS) ]] Axis : uint32_t
	{
		//Mouse
		MOUSE_X = 0,
		MOUSE_Y = 1,
	...
	enum class [[ Reflected, Default(UNKNOWN_BUTTON) ]] Buttons : uint32_t
	{
		//Keyboard
		/* Printable keys */
	...
	enum class  [[ Reflected, Default(RELEASED) ]] ActionMappingState : uint32_t
	{
		RELEASED = 0,
		PRESSED = 1,
		HELD = 2,
